...
pickle.dump(clf, open('./server/saved_objects/svc.bin', mode = 'wb'))
pickle.dump(svd, open('./server/saved_objects/svd.bin', mode = 'wb'))
pickle.dump(index, open('./server/saved_objects/feature_index.bin', mode = 'wb'))    