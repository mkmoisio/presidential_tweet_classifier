...
pickle.dump(clf, open('./saved_objects/svc', mode = 'wb'))
pickle.dump(svd, open('./saved_objects/svd', mode = 'wb'))
pickle.dump(index, open('./saved_objects/feature_index', mode = 'wb'))    